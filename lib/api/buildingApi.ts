...
import { CreateBuildingReq } from '../model/createBuildingReq';
import { CreateBuildingRsp } from '../model/createBuildingRsp';
import { DeleteRsp } from '../model/deleteRsp';
import { FindOneBuildingRsp } from '../model/findOneBuildingRsp';
import { UpdateBuildingReq } from '../model/updateBuildingReq';
import { UpdateBuildingRsp } from '../model/updateBuildingRsp';
...
export enum BuildingApiApiKeys {
}
...
export class BuildingApi {
    ...
    public setApiKey(key: BuildingApiApiKeys, value: string) {
        (this.authentications as any)[BuildingApiApiKeys[key]].apiKey = value;
    }
    ...
    public async createBuilding (createBuildingReq?: CreateBuildingReq, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreateBuildingRsp;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createBuildingReq, "CreateBuildingReq")
        };
            ...
            return new Promise<{ response: http.IncomingMessage; body: CreateBuildingRsp;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "CreateBuildingRsp");
    ...
    public async deleteBuilding (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteRsp;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteBuilding.');
        }
    ...
    public async getBuilding (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FindOneBuildingRsp;  }> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getBuilding.');
        }
            ...
            return new Promise<{ response: http.IncomingMessage; body: FindOneBuildingRsp;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "FindOneBuildingRsp");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    public async updateBuilding (updateBuildingReq?: UpdateBuildingReq, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpdateBuildingRsp;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateBuildingReq, "UpdateBuildingReq")
        };
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpdateBuildingRsp;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "UpdateBuildingRsp");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
